...
public class DislikedFoods extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.disliked_foods_list);
    ...
    private void getData(){
        ...
        StringRequest stringRequest =  new StringRequest(new Database_URL("/LikedFoods","/getDislikedFood.php").getURL(),
    ...
    private void getAliments(JSONArray j){
        ...
        recyclerViewadapter = new AlimentAdapter(this, aliments, "disliked_foods");
