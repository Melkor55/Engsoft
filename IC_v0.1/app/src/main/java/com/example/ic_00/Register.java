...
public class Register extends AppCompatActivity {
    ...
    EditText textInputEditTextName, textInputEditTextUsername, textInputEditTextEmail, textInputEditTextPassword, textInputEditTextRepeatPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textInputEditTextRepeatPassword = (EditText) findViewById(R.id.register_passwordField2);
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            {
                String name,username,email,password, repeat_password;
                ...
                if( !name.equals("") && !username.equals("") && !email.equals("") && !password.equals("") && !repeat_password.equals("") )
                {
