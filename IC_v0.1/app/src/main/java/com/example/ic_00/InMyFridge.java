...
public class InMyFridge extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_in_my_fridge);

        recyclerView = (RecyclerView) findViewById(R.id.fridge_foods_list);
        ...
        AddButton = (Button) findViewById(R.id.add_fridge_foods);
        AddButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(InMyFridge.this, AddFoodInFridge.class);
        ...
        StringRequest stringRequest =  new StringRequest(new Database_URL("/LikedFoods","/getFridgeFood.php").getURL(),
        ...
        recyclerViewadapter = new AlimentAdapter(this, aliments, "my_fridge");
